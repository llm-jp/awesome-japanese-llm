...
| [PLaMo 2 8B](https://tech.preferred.jp/ja/blog/plamo-2-8b/) | **2025** | Samba ベースのアーキテクチャ<br>([**8b**](https://huggingface.co/pfnet/plamo-2-8b)) | | 日本語、英語等のデータ<br>（計 **6T** トークン） | Preferred Elements (Preferred Networks) | PLaMo community license |
